...
# Evaluate entity-pair distances
re_dist_cnt = {}
correct_re_dist_cnt = {}
...
output_filename = os.path.join(output_dir, 'eval_re_dist.txt')
...
# find the minimum sentence number between a given entity pair
...
# recall, precision, f1 score v.s. distance from 0-10
...
# recall, precision, f1 v.s. distance 0, 1, 2-5, >5
...
# 0
actual, recall, precision, f1 = get_p_r_f1(0, 1)
print('\t 0 \t\t {} \t\t {:.4f} \t\t {:.4f} \t\t {:.4f}'.format(actual, recall, precision, f1))
output_file.write('\t 0 \t\t {} \t\t {:.4f} \t\t {:.4f} \t\t {:.4f}\n'.format(actual, recall, precision, f1))
#1
actual, recall, precision, f1 = get_p_r_f1(1, 2)
print('\t 1 \t\t {} \t\t {:.4f} \t\t {:.4f} \t\t {:.4f}'.format(actual, recall, precision, f1))
output_file.write('\t 1 \t\t {} \t\t {:.4f} \t\t {:.4f} \t\t {:.4f}\n'.format(actual, recall, precision, f1))
#2-5
actual, recall, precision, f1 = get_p_r_f1(2, 6)
print('\t 2-5 \t\t {} \t\t {:.4f} \t\t {:.4f} \t\t {:.4f}'.format(actual, recall, precision, f1))
output_file.write('\t 2-5 \t\t {} \t\t {:.4f} \t\t {:.4f} \t\t {:.4f}\n'.format(actual, recall, precision, f1))
#>5
actual, recall, precision, f1 = get_p_r_f1(6, len(re_dist_cnt))
print('\t >5 \t\t {} \t\t {:.4f} \t\t {:.4f} \t\t {:.4f}'.format(actual, recall, precision, f1))
output_file.write('\t >5 \t\t {} \t\t {:.4f} \t\t {:.4f} \t\t {:.4f}\n'.format(actual, recall, precision, f1))
...
# # 0: Intra-sentential instances
# actual, recall, precision, f1 = get_p_r_f1(0, 1)
# print('\t Intra-Sentence \t\t {} \t\t {:.4f} \t\t {:.4f} \t\t {:.4f}'.format(actual, recall, precision, f1))
# output_file.write('\t Intra-Sentence \t\t {} \t\t {:.4f} \t\t {:.4f} \t\t {:.4f}\n'.format(actual, recall, precision, f1))
#
# #>0: Inter-sentential instances
