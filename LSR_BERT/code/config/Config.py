...
class Config(object):
    ...
    def load_train_data(self):
        ...
        self.data_train_seg_bert = np.load(os.path.join(self.data_path, prefix + '_seg_bert.npy'))
    ...
    def load_test_data(self):
        ...
        self.data_test_seg_bert = np.load(os.path.join(self.data_path, prefix + '_seg_bert.npy'))
    ...
    def get_train_batch(self):
        ...
        context_seg_bert = torch.LongTensor(self.batch_size, self.max_length).cuda()
        ...
        for b in range(self.train_batches):
            ...
            for i, index in enumerate(cur_batch):
                ...
                context_seg_bert[i].copy_(torch.from_numpy(self.data_train_seg_bert[index, :]))
                #print("context_set_bert: ", i, context_seg_bert[i])
            ...
            yield {'context_idxs': context_idxs[:cur_bsz, :max_c_len].contiguous(),
                   ...
                   'context_seg_bert': context_seg_bert[:cur_bsz, :max_c_len].contiguous(),
    ...
    def get_test_batch(self):
        ...
        for b in range(self.test_batches):
            ...
            for i, index in enumerate(cur_batch):
                ...
                context_seg_bert[i].copy_(torch.from_numpy(self.data_test_seg_bert[index, :]))
    ...
    def train(self, model_pattern, model_name):
        ...
        for epoch in range(self.max_epoch):
            ...
            for no, data in enumerate(self.get_train_batch()):
                ...
                context_seg_bert = data['context_seg_bert']
                ...
                reverse_sent_idxs = reverse_sent_idxs.cuda()
                context_masks = context_masks.cuda()
                context_starts = context_starts.cuda()
                ...
                if torch.sum(torch.isnan(predict_re)):
                    print(torch.sum(torch.isnan(predict_re)))
